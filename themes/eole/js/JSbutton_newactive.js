function JSButton(x, y, w, h, label, name, fonDown, fonUp, fonDbleClick, N_img, H_img, btn_index, state, hover_color, hover_bar_bottom, H_img_dark) {
