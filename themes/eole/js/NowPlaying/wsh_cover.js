...
function Display(x, y, w, h, prop) {
	...
	prttp.SetImage = function(type, img) {
		...
		if(this.img && this.img != cover_default) this.img = undefined;
...
/*
	...
	//if (this.Properties.MenuButton.Show) {
		this.menuButton = new function(x, y, w, h) {
			...
			g.FillSolidRect(1, 1, img_btn.width - 2, img_btn.height / 3 - 2, RGBA(0, 0, 0, 80));
			g.FillSolidRect(1, img_btn.height / 3 + 1, img_btn.width - 2, img_btn.height / 3 - 2, RGBA(0, 0, 0, 120));
			g.FillSolidRect(1, img_btn.height * 2 / 3 + 1, img_btn.width - 2, img_btn.height / 3 - 2, RGBA(0, 0, 0, 140));
...
function Controller(imgArray, imgDisplay, prop) {
	...
	this.funcMenu = new function() {
		...
		this.Build = function() {
			...
			funcs[id] = [_this.Reload, null];
			baseMenu.AppendMenuItem(MF_STRING, id++, "Reload");			
