...
var globalProperties = {
	theme_version: '1.2.2b22',
	lastest_breaking_version: '1.2.2b16',	
...
const get_albumArt_async = async(metadb, albumIndex, cachekey, need_stub, only_embed, no_load) =>
{
	...
	if(isImage(result.image)) {
		...
		try {		
			...
			brw.repaint();
		} catch(e){fb.ShowPopupMessage("albumIndex undefined "+albumIndex+" brw.groups.length:"+brw.groups.length, "Error");}	
	}
