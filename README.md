...
If you've got some knowledge in javascript, feel free to suggest code performance improvements, to report bugs and their fixes, or even new features for this theme. Open an issue ticket, share the code on [pastebin.com](https://www.pastebin.com) or do a pull request, I'll review it and merge it to the master code. I can also add your github account to the collaborators of this repository, just ask!
