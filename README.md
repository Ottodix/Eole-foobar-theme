...
1. Download this [github repository](https://github.com/Ottodix/Eole-foobar-theme/zipball/master/) and copy everything into your foobar installation directory (so the 3 folders: user-components, themes and plugins). 
